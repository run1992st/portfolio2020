...
<transition name="paint">
 ...
 v-if="animated"
 key="animated"
    class="absolute -top-24 w-48 h-48 rounded-full"
  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        x1="-.348"
        x2="1.251"
        gradientTransform="rotate(116.11 53.1 202.97) scale(86.48)"
      ...
      <linearGradient
        ...
        x1="-.456"
        x2=".582"
        gradientTransform="rotate(-36.46 550.85 -214.34) scale(132.8)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      <linearGradient
        ...
        x1=".043"
        x2=".984"
        gradientTransform="translate(192.86 279.65) scale(97.417)"
        gradientUnits="userSpaceOnUse"
      >
    ...
    <path
      ...
      fill-rule="evenodd"
    />
    <g transform="translate(-78.306 -164.02)" clip-path="url(#l)">
      <path d="m331.36 246.79-118.72-58.19-60.87 124.17 118.71 58.193z" fill="url(#k)" />
    </g>
    <g transform="translate(-78.306 -164.02)" clip-path="url(#j)">
      <path d="m144.07 264 83.825 113.45 110.86-81.906-83.83-113.45z" fill="url(#i)" />
    </g>
    <g transform="translate(-78.306 -164.02)" clip-path="url(#h)">
  ...
  v-if="!animated"
key="draft"
    class="absolute -top-24 w-48 h-48"
    viewBox="0 0 442.37 270.93"
    xmlns="http://www.w3.org/2000/svg"
  >
    <defs>
    ...
    <g transform="translate(-78.306 -164.02)" clip-path="url(#l)">
      <path d="m331.36 246.79-118.72-58.19-60.87 124.17 118.71 58.193z" />
    </g>
    <g transform="translate(-78.306 -164.02)" clip-path="url(#j)">
      <path d="m144.07 264 83.825 113.45 110.86-81.906-83.83-113.45z" />
    </g>
    <g transform="translate(-78.306 -164.02)" clip-path="url(#h)">
      <path d="m197.02 225.93v107.43h91.683v-107.43z" />
    </g>
  </svg>
</transition>
